...
function sumArray(sumArr) { //eslint-disable-line
  ...
  var sum1 = sum(arr0,arr1);
  
  var sum2 = sum(sum1[0], sumArr[2]);
  
  // sum(sumArr[0],sumArr[1])[0],sumArr[2])    ***************** ORIGINAL BEFORE BREAKING It APART *******************
  var result = [sum2[0], sumArr + ' was passed in as an array of numbers, and ' + sum2[0] + ' is their sum.'];
  console.log(result);
  return result;
}
...
function multiplyArray(multArr) { //eslint-disable-line
  ...
  var prod2 = multiply(prod1[0], multArr[2]);

  var result = [prod2[0], 'The numbers ' + multArr + ' have a product of ' + prod2[0] +'.'];
  return result;
  //multiply(multiply(multArr[0], multArr[1])[0], multArr[2]);
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
  var product = 1;
  var bitsToGetMultiplied;
  for (var i = 0; i < dynamicArray.length; i++) {
    bitsToGetMultiplied = dynamicArray[i];
    var multArray = multiply(product, bitsToGetMultiplied);
    product = multArray[0];
  }
